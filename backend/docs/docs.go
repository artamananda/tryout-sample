...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.SaveChatLogRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.GenerateQuestionsRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateBankSoalRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateBankSoalBatchRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateLearningVideoRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateLearningVideoRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "model.CreateBankSoalBatchRequest": {
            "type": "object",
            "required": [
                "questions"
            ],
        ...
        "model.CreateLearningVideoRequest": {
            "type": "object",
            "required": [
                "title",
                "url"
        ...
        "model.GenerateQuestionsRequest": {
            "type": "object",
            "required": [
                "difficulty",
                "number_of_questions",
        ...
        "model.UpdateLearningVideoRequest": {
            "type": "object",
            "properties": {
                "program_id": {
                    "type": "string"
