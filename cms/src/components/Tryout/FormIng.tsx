...
const FormIng = () => {
  ...
  return (
    <Form layout="vertical" onFinish={handleUpdateQuestion}>
      <Title>Literasi Bahasa Inggris</Title>
      {Array.from({ length: questionLength }, (_, index) => (
        <React.Fragment key={index}>
          <Form.Item
            name={`question_${index + 1}_ing`}
